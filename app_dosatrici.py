...
# --- TAB 3: POOL ASSISTANT (Inclusa Sezione Sale) ---
with tab3:
    ...
    if st.button("CALCOLA INTERVENTI", type="primary", use_container_width=True):
        ...
        # LOGICA SALE
        # Conversione g/mc in kg/mc per confronto con i target 4.5 e 1.5
        ...
        # LOGICA PARAMETRI CHIMICI (da Pool Assistant.html)
        cya_reale = cya_ril / 2
